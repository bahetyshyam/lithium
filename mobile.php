			...
			<div class="nav-wrapper">
				...
				<div class="sidebar black">
					<div class="sideItems" id="first">
						<a class="sideLinks" href="brands.php"><i
								class="medium sideIcons material-icons">search</i>Brands</a>
					</div>
					<div class="sideItems">
						<a class="sideLinks" href="categories.php"><i
								class="medium sideIcons material-icons">folder</i>Categories</a>
					</div>
				</div>
		...
		<div class='row'>
			...
			<div id='mobile-spec' class='col m5 l5 grey darken-4'>
				...
				<div class='spec-items'>
					<p class='spec-desc'><i style='margin-right: 20px; font-size: 30px;'
							class='sideIcons fas fa-microchip'></i><?php echo $mobile->getSoc() ?></p>
				</div>
				<div class='spec-items'>
					<p class='spec-desc'><i style='margin-right: 20px; font-size: 30px;'
							class='sideIcons fas fa-mobile-alt'></i><?php echo $mobile->getDisplay() ?></p>
				</div>
				<div class='spec-items'>
					<p class='spec-desc'><i style='margin-right: 20px; font-size: 30px;'
							class='sideIcons fas fa-camera'></i><?php echo $mobile->getCamera() ?></p>
				</div>
				<div class='spec-items'>
					<p class='spec-desc'><i style='margin-right: 20px; font-size: 30px;'
							class='sideIcons fas fa-battery-three-quarters'></i> <?php echo $mobile->getBattery() ?></p>
				</div>
				<?php 
	...
	<div class="prosConsContainer">
		<div id="mobile-pros-cons" class="row grey darken-4">
			...
			<?php 
				...
				foreach($prosArray as $value) {
					echo "<div class='proscons-div'>
					<p class='proscons-item'>$value</p></div>";
				} 
			?>
			</div>
			<div id="cons" class="col m6 l6">
				<h3>
					Cons
				</h3>
			<?php 
